...
export default function JarvisOrb() {
  ...
  useEffect(() => {
    ...
    try {
      ...
      console.error("Failed to create orb scene:", err);
      setError("3D ENGINE INITIALIZATION FAILED");
    }
  }, []);
    ...
    try {
      ...
      if (err instanceof DOMException) {
        switch (err.name) {
          ...
          case "SecurityError":
            setError("CAMERA BLOCKED BY SECURITY POLICY");
            break;
